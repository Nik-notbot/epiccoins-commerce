...
const Index = () => {
  ...
  const products = [
    {
      ...
      basePrice: 0.8, // цена за 1 V-buck в рублях
      packages: [
    ...
    },
    {
      ...
      basePrice: 0.87, // цена за 1 Робукс в рублях
      packages: [
  ...
  const calculatePrice = (productId: number, amount: number) => {
                ...
                <CardContent>
                  ...
                  <div className="mb-6 p-4 rounded-lg bg-muted/30 border">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          onClick={() =>
                            updateAmount(
                              product.id,
                              (selectedAmounts[product.id] || 0) - 100,
                            )
                          }
                        ...
                        <div className="flex-1">
                          <Input
                            ...
                            value={selectedAmounts[product.id] || ""}
                            onChange={(e) =>
                              updateAmount(
                                product.id,
                      ...
                      {selectedAmounts[product.id] > 0 && (
                        <div className="flex justify-between items-center p-3 rounded-lg bg-primary/10 border border-primary/20">
                          <span className="text-sm font-medium">
                            {selectedAmounts[product.id]?.toLocaleString()}{" "}
                            единиц
                          </span>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {product.packages.map((pkg, index) => (
                        <div
                          ...
                          onClick={() => updateAmount(product.id, pkg.amount)}
                        >
                          {pkg.popular && (
